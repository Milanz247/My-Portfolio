        ...
        <div className="bg-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              {/* Project Type Field */}
              <div className="space-y-2">
                <Label htmlFor="projectType" className="text-sm font-medium text-card-foreground">
                  Project Type *
                </Label>
                <select
                  id="projectType"
                  name="projectType"
                  required
                  className="h-10 sm:h-12 w-full rounded-md border border-border bg-background px-3 py-2 text-sm sm:text-base ring-offset-background focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                >
